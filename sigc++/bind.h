...
inline ::sigc::bind_functor<0, typename ::sigc::unwrap_reference<T_bound1>::type, T_functor>
bind(const T_functor& _A_func, T_bound1 _A_b1)
{ 
  return ::sigc::bind_functor<0, typename ::sigc::unwrap_reference<T_bound1>::type, T_functor>
           (_A_func, _A_b1);
}

template <class T_bound1, class T_bound2, class T_functor>
inline ::sigc::bind_functor<0, typename ::sigc::unwrap_reference<T_bound1>::type,
       ::sigc::bind_functor<0, typename ::sigc::unwrap_reference<T_bound2>::type, T_functor> >
bind(const T_functor& _A_functor, T_bound1 _A_b1, T_bound2 _A_b2)
{ 
  return ::sigc::bind_functor<0, typename ::sigc::unwrap_reference<T_bound1>::type,
         ::sigc::bind_functor<0, typename ::sigc::unwrap_reference<T_bound2>::type, T_functor> >
...
inline ::sigc::bind_functor<0, typename ::sigc::unwrap_reference<T_bound1>::type,
       ::sigc::bind_functor<0, typename ::sigc::unwrap_reference<T_bound2>::type,
       ::sigc::bind_functor<0, typename ::sigc::unwrap_reference<T_bound3>::type, T_functor> > >
